...
export function OverviewScreen({ initialDisplaySettingsOpen = false, initialInviteCustomizerOpen = false }: OverviewScreenProps = {}) {
  ...
  return (
    <div className="flex-1 h-screen overflow-auto bg-[#F5F1E8]">
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              {/* Total Members */}
              <Card className="p-6 bg-gradient-to-br from-[#E8DFD0] to-[#D8CFC0] border-2 border-[#8B7355] shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]">
              ...
              {/* Left Brain Metrics - Collapsible Card Spanning 2 Columns */}
              <Card className="col-span-2 bg-gradient-to-br from-[#E8DFD0] to-[#D8CFC0] border-2 border-[#8B7355] shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]">
                <div 
      ...
      {/* Custom Tag Modal */}
      <Dialog open={tagModalOpen} onOpenChange={handleCloseTagModal}>
